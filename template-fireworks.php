...
?>
	...
	<div id="<?php echo $page_id; ?>" role="main" class="page-content">
		...
		<div class="column_wrapper row">
			...
			<div id="column_1" class="col-xs-12">
				<section>
					<div class="content_wrap">
...
// Fireworks amends by DR 04-11-2016 @ 17:50
// fireworks-col (below) removed
// also removed the TicketScript javascript routine from footer.php and saved as REMOVED_FIREWORKS_SCRIPT_DR.js
// just-in-case it is required again.
							
							if (have_posts()): while (have_posts()) : the_post(); ?>
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									<!-- <div id="fw" class="fireworks-col">&nbsp;</div> -->
									<div class="fireworks-colX">
										<?php the_content(); ?>
									</div>
								</article>
							<?php 
