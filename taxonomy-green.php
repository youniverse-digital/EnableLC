	...
	<div id="<?php echo $page_id; ?>" role="main" class="page-content">
		...
		<section class="row">
			<div class="column_wrapper clearfix">
				<h2 class="page-title blog-title">Green places - <?php echo $post_t_name; ?></h2>
					...
					<div class="content_wrap">
						...
						if ($the_query->have_posts()){
							...
							while ($the_query->have_posts()){
								$the_query->the_post(); 
								echo '<li id="post-'.get_the_ID().'" class="taxonomy_item"><a href="'.get_the_permalink().'" title="'.the_title_attribute( 'echo=0' ).'">'.get_the_title().'</a></li>';
							}
							echo '</ul>';
						} else {
							echo '
							<article class="type-green_spaces taxonomy_item">
